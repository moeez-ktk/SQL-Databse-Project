...
const WorkerHome = () => {
    ...
    const updateStatus = async (status, BookId) => {
        console.log(`${status}  ${tableContent}  ${BookId}`)
    ...
    const getDataCondition = async (_condition) => {
        console.log('get data condition called\n')
            ...
            <div className='submainContainer'>
                ...
                <div className="summary">
                    ...
                    <div className="summaryContainer">
                        ...
                        <span className='value'>{pending?pending.Pending:summary.Pending}</span>
                    </div>

                    <div className="summaryContainer">
                        <span className="valueOf">Completed Tasks</span>
                        <span className='value'>{pending?pending.Completed:summary.Completed}</span>
                    </div>
                    ...
                    <div className='tableContainer'>
                        ...
                        <div className="table">
                            {tableData.map((cust) =>
                                ...
                                // <Task date={cust.BookDate} startTime={cust.BookTime} endTime={cust.EndTime} name={cust.CustFirstName} address={cust.CustCity} status={cust.Status} />
                            )}
                            {/* {tableData.map((cust) =>
                                <Task date={cust.BookDate} startTime={cust.BookTime} endTime={cust.EndTime} name={cust.CustFirstName} address={cust.CustCity} status={cust.Status} />
                            )}
