...
import plumber from "../../characters/taylor.jpg";
...
const WorkerCard = (props) => {
  ...
  return (
    <>
        ...
        <div className="worker-card">
          <div className="left-side">
            ...
            <div className="btn-box">
              <div className="btn">
                {/* <div className="btnText" onClick={<Popup/>} >Hire Me</div> */}
      ...
      {modal && (
        <div className="modal">
          {/* <div onClick={showPopup} className="overlay"></div> */}
                ...
                <div className="col-2">
                  ...
                  <div className="confirm">
                    <div className="confirm-btn">
                      ...
                      {/* <onclick to ="" className = "btnText">Confirm</onclick> */}
                    </div>
                  </div>
                </div>
